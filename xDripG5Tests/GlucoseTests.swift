...
class GlucoseTests: XCTestCase {
    ...
    func testMessageData() {
        ...
        XCTAssertEqual(204, glucose.glucose?.doubleValue(for: HKUnit.milligramsPerDeciliter()))
    ...
    func testNegativeTrend() {
        ...
        XCTAssertFalse(glucose.isDisplayOnly)
        XCTAssertEqual(122, glucose.glucose?.doubleValue(for: HKUnit.milligramsPerDeciliter()))
        XCTAssertEqual(CalibrationState.ok, glucose.state)
    ...
    func testDisplayOnly() {
        ...
        XCTAssertEqual(88, glucose.glucose?.doubleValue(for: HKUnit.milligramsPerDeciliter()))
        XCTAssertEqual(CalibrationState.ok, glucose.state)
    ...
    func testOldTransmitter() {
        ...
        XCTAssertFalse(glucose.isDisplayOnly)
        XCTAssertEqual(139, glucose.glucose?.doubleValue(for: HKUnit.milligramsPerDeciliter()))
        XCTAssertEqual(CalibrationState.ok, glucose.state)
